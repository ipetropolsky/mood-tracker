            ...
            <div className="controls">
                <div className="selection">
                    {eyesConfig.map((eyeConfig) => {
                        return (
                            <div
                                className={`part ${eyeConfig === selectedEyes ? 'part-selected' : ''}`}
                                style={getStyle(eyeConfig)}
                                onClick={() => {
                ...
                <div className="selection">
                    {mouthConfig.map((mouthConfig) => {
                        return (
                            <div
                                className={`part ${mouthConfig === selectedMouth ? 'part-selected' : ''}`}
                                style={getStyle(mouthConfig)}
                                onClick={() => {
